         ...
         productDetails.innerHTML = `
            ...
            <section>
             ...
             <section>
               ...
               <main>
               <button class="button" onclick="validation()">add to cart</button>
               <button class="button-1"><a href="guesthome.html">Back to Home</a></button>
               </main>
             </section>
            </div>
            <div class="review">
...
function validation(){
    if(confirm("please login to add elements in your cart!Click ok to go to Login form")){
        window.location.href = "logfinal.html";
    }
}